...
public class DeepStubTest {
  ...
  // TODO Deep stubs are used to return inner mocks from a mock; basically, if we have a chain of
  // inner objects inside
  //  a mock that need to be called to reach the method under test we have two option: explicitly
  // stub the behavior of
  //  each element in the chain, or directly leave mockito do the nested stubbing by telling him
  // that the first mock
  ...
  void withoutDeepStub() {
    ...
    // TODO Address is a field to the ContactInformation class, therefore, if we want to stub its
    // behavior starting
