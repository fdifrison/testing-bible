...
class MocksBasicTest {
  ...
  class MockWithAnnotations {
    ...
    @Mock private SimpleRepository repository;

    @InjectMocks private SimpleService service;

    @BeforeEach
    void setUp() {
      // search for the @Mock annotated objects
      MockitoAnnotations.openMocks(this);
      // TODO we could manually instantiate the service or let @InjectMocks looking for a suitable
      // constructor
