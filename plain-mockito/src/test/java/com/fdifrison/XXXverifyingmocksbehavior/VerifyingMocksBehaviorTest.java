...
public class VerifyingMocksBehaviorTest {
  ...
  // TODO N.B. overuse of verification lead to tight coupling between tests and code, making
  // refactoring much harder..
  //  Hence, DO NOT ABUSE!
  ...
  void basicMocksVerification() {
    ...
    // TODO with verify we can investigate the mock behavior and also how many time it should have
    // been invoked
    ...
    // TODO with verifyNoMoreInteractions() we are telling mockito that all the planned interaction
    // between the
  ...
  void verifyingWithArgumentsCaptor() {
    ...
    // TODO argumentsCaptors allow us to investigate the objects used or returned by the mocks
    // during the verify
    // phase
